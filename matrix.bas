001 REM A COMMANDER X16 (R31) BASIC V2 PROGRAM THAT DRAWS THE MATRIX SCREEN 
002 REM THINGY ON THE SCREEN BUT SINCE THIS IS WRITTEN IN BASIC IT IS SUUUUUPER
003 REM SLOW.
004 REM BY MEDIC7500
005 REM HTTPS://GITHUB.COM/MEDIC5700/MATRIX-SCREEN-COMMANDER-X16
...
200 REM SETS FIRST 16 ENTRIES OF COLOUR PALLET TO GREEN SCALE
210 FOR I = 0 TO 15
220   VPOKE $F, $1000 + I*2, I*16
230   VPOKE $F, $1000 + I*2 + 1, 0
240 NEXT

300 REM SETS UP 'CODE STREAMERS' DATA STRUCTURES
...
510 IF RND(1) > 0.75 THEN GOTO 600 :REM A CHANCE TO SPAWN NEW STREAMERS
...
600 FOR I = 0 TO AMOUNT :REM INTERATES THROUGH ALL STREAMERS
610   IF ACTIVE(I) = O THEN 740 :REM SKIPS INACTIVE STREAMERS
620   X = CODE%(I, 0)
630   Y = CODE%(I, 1)
640   VPOKE 0, Y*256 + X*2, INT(RND(1)*128)+32 :REM NEW RANDOM CHARACTER
...
680     IF J < 0 OR J > 80 THEN GOTO 720    :REM SKIPS IF OFF THE SCREEN
